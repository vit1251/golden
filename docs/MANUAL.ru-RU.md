...
Поле Origin содержит Ориджин.

Примечание: Поле может прнимать имя файла в кодировке UTF-8 с лидирующим символом @.
            В этом случае будет выбрана случайная строка из файла.
