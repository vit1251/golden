...
type FileEchoRemoveCompleteHandler struct {
	registry *registry.Container
}

func NewFileEchoRemoveCompleteHandler(registry *registry.Container) *FileEchoRemoveCompleteHandler {
	return &FileEchoRemoveCompleteHandler{
		registry: registry,
	}
}

func (self FileEchoRemoveCompleteHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
