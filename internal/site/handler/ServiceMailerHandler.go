...
type ServiceMailerHandler struct {
	registry *registry.Container
}

func NewServiceMailerHandler(registry *registry.Container) *ServiceMailerHandler {
	return &ServiceMailerHandler{
		registry: registry,
	}
}

func (self *ServiceMailerHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
...
func (self *ServiceMailerHandler) renderRow(s *mapper.StatMailer) widgets2.IWidget {
