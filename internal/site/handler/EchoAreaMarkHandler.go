...
type EchoAreaMarkHandler struct {
	registry *registry.Container
}

func NewEchoAreaMarkHandler(registry *registry.Container) *EchoAreaMarkHandler {
	return &EchoAreaMarkHandler{
		registry: registry,
	}
}

func (self *EchoAreaMarkHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
