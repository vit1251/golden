...
type ServiceTrackerHandler struct {
	registry *registry.Container
}

func NewServiceTrackerHandler(registry *registry.Container) *ServiceTrackerHandler {
	return &ServiceTrackerHandler{
		registry: registry,
	}
}

func (self *ServiceTrackerHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
