...
func (self *NetmailIndexHandler) renderRow(m *mapper.NetmailMsg) widgets2.IWidget {
...
func (self NetmailIndexHandler) renderHandlers() widgets2.IWidget {
	...
	handlerLabel := i18n.GetText(mainLanguage, "NetmailIndexHandler", "handler-button-create")
