...
func (self *EchoAreaIndexHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
...
func (self *EchoAreaIndexHandler) renderMessageCounter(area *mapper.Area) widgets2.IWidget {
...
func (self *EchoAreaIndexHandler) renderRow(area *mapper.Area) widgets2.IWidget {
...
func (self *EchoAreaIndexHandler) renderHandlers() widgets2.IWidget {
	...
	actionLabel := i18n.GetText(mainLanguage, "EchoAreaIndexHandler", "handler-button-create")
