...
func (self NetmailViewHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
...
func (self NetmailViewHandler) makeMessageHeaderRowSection(headerTable *widgets2.TableWidget, name widgets2.IWidget, value widgets2.IWidget) {
...
func (self NetmailViewHandler) makeMessageHeaderSection(origMsg *mapper.NetmailMsg, msgBody *packet.MessageBody) widgets2.IWidget {
...
func (self NetmailViewHandler) renderHandlers(origMsg *mapper.NetmailMsg) widgets2.IWidget {
