...
func (self *EchoMsgDumpHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
...
func (self *EchoMsgDumpHandler) renderHandlers(area *mapper.Area, origMsg *msg.Message) widgets2.IWidget {
