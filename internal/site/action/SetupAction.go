...
func (self *SetupAction) createInputField(box *widgets2.VBoxWidget, param setupParam) {
...
func (self SetupAction) makeSectionWithSettings(s setupSection) widgets2.IWidget {
...
func (self SetupAction) makeSectionsWithSettings(setupSections []setupSection) widgets2.IWidget {
