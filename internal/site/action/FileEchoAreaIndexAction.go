...
func (self *FileEchoAreaIndexAction) renderRow(area *mapper.FileArea, file *mapper.File) widgets2.IWidget {
...
func (self *FileEchoAreaIndexAction) renderActions(area *mapper.FileArea) widgets2.IWidget {
